        ...
        <div class="formInput my-2">
            <span>
                ...
                <div class="form-group">
                    <label for="exampleFormControlSelect${formCount}" contenteditable="true" class="font-weight-bold">Example select ${formCount}</label>
                    <button type="button" class="input-group-append btn delete-button float-right"><i class="fas fa-times"></i></button>
...
$("#multipleSelectField").on("click", function(){
    ...
    $("#thisForm").append(`
        <div class="formInput my-2">
            ...
            <i class="fas fa-arrows-alt move-button float-left mr-2"></i> 
                <div class="form-group">
                    <label for="exampleFormControlSelect${formCount}" contenteditable="true" class="font-weight-bold">Example multiple select ${formCount}</label>
                    <button type="button" class="input-group-append btn delete-button float-right"><i class="fas fa-times"></i></button>
...
$("#addTextArea").on("click", function(){
    ...
    $("#thisForm").append(`
        <div class="formInput my-2">
            ...
            <i class="fas fa-arrows-alt move-button float-left mr-2"></i> 
                <div class="form-group">
                    <label for="exampleFormControlTextarea${formCount}" contenteditable="true" class="font-weight-bold">Example textarea ${formCount}</label>
                    <button type="button" class="input-group-append btn delete-button float-right"><i class="fas fa-times"></i></button>
